...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<section class="home-section home-intro">
		<div class="container">
			...
			<?php if($intro): ?>
			<div class="intro-left scroll-animate-item">
				<?php if($intro['title']): ?>
			...
			<div class="intro-right scroll-animate-item">
	...
	<section class="home-section home-practice-areas">
		<div class="container">
			...
			<div class="section-header scroll-animate-item">
	...
	<section class="home-section home-advantages">
		<div class="container">
			...
			<ul class="advantages-grid scroll-animate-item">
	...
	<section class="home-section home-staff">
		<div class="container">
			...
			<div class="staff-grid">
				...
				<div class="staff-grid-inner scroll-animate-item">
	...
	<section class="home-section home-results">
		<div class="container">
			...
			<ul class="results-grid scroll-animate-item">
			...
			<?php if($results_section['note']): ?>
				<p class="results-note scroll-animate-item"><?php echo $results_section['note']; ?></p>
			<?php endif; ?>
			<?php if($results_section['buttons']): ?>
				<div class="section-buttons scroll-animate-item">
	...
	<section class="home-section home-reviews">
		<div class="container">
			...
			<div class="reviews-slider-wrap scroll-animate-item">
