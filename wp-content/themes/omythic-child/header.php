...
<body <?php body_class(); ?>>
	...
	<?php $ocn_contact = get_field( 'contact', 'option' ); ?>
	<div id="ocn">
		<div id="ocn-inner">

			<div id="ocn-top">
				<svg class="ocn-logo-bg" xmlns="http://www.w3.org/2000/svg" width="50" height="70" viewBox="0 0 50 70" fill="none">
				...
				<div class="ocn-top-text">
					<div class="ocn-menu-title">Menu</div>
					<div class="ocn-menu-description">Navigate Our Site</div>
				</div>
				<button name="Mobile navigation toggle" aria-pressed="false" class="nav-toggle" type="button" id="ocn-close" aria-labelledby="ocn-toggle-label">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="44" height="22" viewBox="0 0 44 22" fill="none">
					  <rect y="9" width="42" height="4" fill="#9B7839"/>
					  <path d="M27.1387 17.5L42 9.00003L42 13L27.1386 21.9641L27.1387 17.5Z" fill="#9B7839"/>
					  <path d="M27.1387 4.5L42.0001 12.9641L42.0001 8.96406L27.1388 -3.70704e-05L27.1387 4.5Z" fill="#9B7839"/>
					</svg>
				</button>
			</div>
			...
			<?php if ( $ocn_contact && ( $ocn_contact['phone'] || $ocn_contact['email'] ) ) : ?>
			<div id="ocn-contact">
				<h3 class="ocn-contact-title">Contact Us</h3>
				<?php if ( $ocn_contact['phone'] ) : ?>
					<a class="ocn-contact-link" href="tel:<?php echo esc_attr( preg_replace( '/[^0-9+]/', '', $ocn_contact['phone'] ) ); ?>">
						<span class="fas fa-phone" aria-hidden="true"></span>
						<span><?php echo esc_html( $ocn_contact['phone'] ); ?></span>
					</a>
				<?php endif; ?>
				<?php if ( $ocn_contact['email'] ) : ?>
					<a class="ocn-contact-link" href="mailto:<?php echo antispambot( $ocn_contact['email'] ); ?>">
	...
	<div id="MainContent" class="wrapper" role="main">
		...
		<?php if( !is_front_page() && !is_page_template( 'template-practice-area.php' ) ) : ?>
