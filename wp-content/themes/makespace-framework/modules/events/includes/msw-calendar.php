...
class MakespaceFrameworkEventsCalendar {
	...
	/* draws a calendar */
	static function draw_calendar($month,$year){
	...
	/* Get Month Name */
	static function get_month_name($m){
		$dateObj = DateTime::createFromFormat('!m', $m);
		return $dateObj->format('F');
	}

	/* Get Previous Month */
	static function get_previous_month($date){
	...
	/* Get Next Month */
	static function get_next_month($date){
	...
	static function day_event_html($event_id){
		...
		if(get_field('start_time', $event_id)){
			...
			if(get_field('end_time', $event_id)){
