	...
	*/
	...
	function get_event_dates($id){
		...
		if($end_date == $start_date){
			...
			$date_html = $start_date_display;
			$date_html .= ' - <span>' . $end_date_display . '</span>';
		}
	...
	function get_event_times($id){
		...
		if(get_field('start_time', $id) && get_field('end_time', $id)){
			...
			return $start_time_display . ' - ' . $end_time_display;
		}
		elseif(get_field('start_time', $id)){
			$start_time = get_field('start_time', $id);
			$start_time_date = date_create($start_time);
			$start_time_display = date_format($start_time_date, 'g:ia');
			
			return $start_time_display;
		}
		return '';
